...
pub(crate) use transitions::{
    ...
    apply_live_evm_simulate_with_provider, apply_live_evm_verify_with_provider,
    ...
    resolve_evm_verify_binding, resolve_solana_actuate_binding, resolve_solana_observe_binding,
