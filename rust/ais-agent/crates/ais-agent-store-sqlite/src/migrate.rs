...
use crate::schema::{
    ...
    CREATE_RUN_CATALOG_TABLE, CREATE_RUN_CLAIMS_ACTIVE_INDEX, CREATE_RUN_CLAIMS_RUN_LOOKUP_INDEX,
    CREATE_RUN_CLAIMS_TABLE, CREATE_SIGNER_STATE_ARCHIVE_TABLE,
};
...
pub fn migrate_connection(conn: &Connection) -> rusqlite::Result<()> {
    ...
    conn.execute_batch(CREATE_RUN_CLAIMS_TABLE)?;
    conn.execute_batch(CREATE_RUN_CLAIMS_ACTIVE_INDEX)?;
    conn.execute_batch(CREATE_RUN_CLAIMS_RUN_LOOKUP_INDEX)?;
